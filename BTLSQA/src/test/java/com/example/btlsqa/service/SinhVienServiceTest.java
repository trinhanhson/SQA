...
public class SinhVienServiceTest extends AbstractTransactionalJUnit4SpringContextTests{
    ...
    public void testLogin_TestSuccess() {
        ...
        SinhVienService instance = new SinhVienService();
        SinhVien expResult = new SinhVien(1,username,password,"Trinh Anh Son","1");
        SinhVien result = instance.login(username, password);
